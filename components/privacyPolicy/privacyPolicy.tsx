  ...
  <div className="privacy-policy">
    ...
    <ol type="1">
      <li>
        Informações gerais
        <p>
          A presenta Política de Privacidade contém informações a respeito do
          ...
          atualizar, gerenciar ou excluir estas informações.
        </p>
        <p>
        ...
        <p>
          ...
          de Dados Pessoais) e com o Regulamento EU n. 2016/679, de 27 de abril
      ...
      <li>
        Direitos do usuário
        <p>
          O site se compromete a cumprir as normas previstas no RGPD, em
          respeito aos seguintes princípios:
        </p>
        <ul>
          <li>
            os dados pessoais dos usuários serão processados de forma lícita,
        ...
        <p>
          O usuário do site possui os seguintes direitos, conferido pela Lei de
          Proteção de Dados Pessoais e pelo RGPD:
        </p>
        <ul>
          <li>
          ...
          <li>
            direito à eliminação: é o direito do usuário de obter do site, sem
            demora injustificada, a retificação dos dados pessoais inexatos que
            lhe digam respeito;
          </li>
          <li>
            direito à limitação do tratamento dos dados: é o direito do usuário
            de limitar o tratamento de seus dados pessoais, podendo obtê-la
            quando contesta a exatidão dos dados, quando o tratamento dos
            ilícito, quando o site não precisar mais dos dados para as
            finalidades propostas e quando tiver se oposto ao tratamento dos
            dados e em caso de tratamento de dados desnecessário;
          </li>
          <li>
            ...
            tratamento dos dados pessoais que lhe digam respeito, podendo se
            opor ainda ao uso de seus dados pessoais para definição de perfil de
            marketing (profiling).
          </li>
          <li>
            direito de portabilidade dos dados: é o direito do usuário de
            receber os dados pessoais que lhe digam respeito e que tenha
            fornecido ao site, num formato estruturado, de uso corrente a
          ...
          <li>
            ...
            definição de perfil (profiling), que produza efeitos na sua esfera
        ...
        <p>
          ...
          escrita enviada ao site com o assunto “RGDP-www.nossovoo.com.br”,
          especificando:
        </p>
        <ul>
          <li>
            ...
            Pessoas Jurídica, da Receita Federal do Brasil) e endereço de e-mail
            do usuário e, se for o caso, do seu representante;
          </li>
        ...
        <p>
          O pedido deverá ser enviado ao e-mail: contato@nossovoto.com.br, ou
          por correio, ao seguinte endereço:
        </p>
        <p>Rua Cabo Verde, 290 – apto 133 – São Paulo – SP 04550-081</p>
        <p>
      ...
      <li>
        ...
        <p>
          ...
          direitos de terreiros, o usuário deverá fornecer somente seus dados
      ...
      <li>
        Coleta de dados
        <p>
          A plataforma nossovoto colete alguns dados pessoais de seus usuários.
          Todas as informações pessoais recolhidas serão usadas para ajudar a
          tornar a visita na plataforma mais produtiva e agradável.
        </p>
        <p>4.1. Tipo de dados coletados</p>
        <p>
        ...
        <p>4.1.2. Dados informados no formulário de contato</p>
        <p>
        ...
        <ul>
          ...
          <li>
            opinião dos usuários sobre questões que estão tramitando no
            Congresso Nacional Brasileiro (Câmara Federal e Senado Federal).
          </li>
          <li>
            opinião dos usuários quanto a pesquisas específicas elaboradas pelo
            nossovoto.
          </li>
        </ul>
        ...
        <p>
          ...
          pessoais antes da retirada. A retirada. A retirada do consentimento
          poderá ser feita pelo e-mail contato@nossovoto.com.br, ou por correio
        ...
        <p>
          ...
          poderá ser feito, respectivamente, se devidamente assistido ou
          representados.
        </p>
        <p>
        ...
        <ul>
          ...
          <li>
            ...
            e liberdade fundamentais do titular dos dados que exijam a proteção
            dos dados pessoais;
          </li>
          <li>
        ...
        <p>
          ...
          dar subsídio ao site para a melhora da qualidade e funcionamento de
          seus serviços.
        </p>
        <p>
          ...
          características pessoais, interesses, fiabilidade, comportamento,
        ...
        <p>
          ...
          ao usuário, sendo que, em qualquer caso, os direito e obrigações aqui
          previstos permanecerão aplicáveis.
        </p>
        <p>4.4. Prazo de conservação dos dados pessoais</p>
        <p>
          Os dados pessoais dos usuários serão conservados por um período não
          superior ao exigidos para cumprir os objetivos em razão dos quais são
          processados.
        </p>
        <p>
          O período de conservação dos dados é definido de acordo com os
          seguintes critérios:
        </p>
        <p>
          Até o momento em que estes dados cumpram seus fins. São eles: emitir a
          opinião do usuário segundo o qual ele mesmo o fez, entrando ele ciente
          e de acordo com os termos deste documento.
        </p>
        <p>
        ...
        <p>
          ...
          que serão tratados apenas por este site.
        </p>
      </li>
      <li>
        ...
        <p>
          ...
          poderá ser contactado pelo e-mail: contato@nossovoto.com.br.
        </p>
        <p>
        ...
        <p>
          ...
          tratem dos dados, a respeito das obrigações do site nos termos do
        ...
        <p>
          Neste site o encarregado de dados (data protection officer) poderá ser
      ...
      <li>
        ...
        <p>
          ...
          riscos para os direitos e liberdade do usuário.
        </p>
        <p>
        ...
        <p>
          ...
          em prazo lhe causar um alto risco para seus direitos e liberdade
          pessoais.
        </p>
        <p>
          A violação de dados pessoais é uma violação é uma violação de
      ...
      <li>
        ...
        <p>
          ...
          armazenadas pelo navegador usuário para que nosso servidor possa
          lê-las posteriormente. Podem ser armazenadas, por exemplo, dados sobre
        ...
        <p>
          É importante ressaltar que nem todo cookie contém informação que
          permitem a identificação do usuário, sendo que determinados tipos de
          cookies podem ser empregados simplesmente para que o site seja
          carregado corretamente ou para que suas funcionalidades funcionam do
          modo esperado.
        </p>
        <p>
          ...
          todas as regras previstas nesta Política de Privacidade também são
          aplicáveis.
        </p>
        <p>7.1. Cookies do site</p>
        <p>
        ...
        <p>
          ...
          preferências e escolhas do usuário, bem como par ao oferecimento de
          conteúdo personalizado.
        </p>
        <p>
          Estes dados de navegação poderão, ainda, ser compartilhados com
          eventuais parceiros do site, buscando o aprimoramento dos produtos e
          serviços ofertados ao usuário.
        </p>
        <p>7.2. Cookies de redes sociais</p>
        <p>
          O site utiliza plug-ins de redes sociais, que permitem acessá-las a
          partir do site. Dessa forma, os cookies de redes sociais podem ser
        ...
        <p>7.3. Gestão dos cookies e configurações do navegador</p>
        <p>
      ...
      <li>
        Das alterações
        <p>
          A presente versão dos termos e condições gerais de uso foi atualizada
          pela ultima vez em: 22/10/2019.
        </p>
        <p>
          O editor se reserva o direito de modificar, a qualquer momento o site
          e os serviços, bem como as presentes normas, especialmente para
          adaptá-las às evoluções do site nossovoto, seja pela disponibilização
          de novas funcionalidade, seja pela supressão ou modificação daquelas
          já existentes.
        </p>
        <p>
          O usuário será explicitamente notificado em caso de alteração do
          presente termo.
        </p>
        <p>
          Caso o usuário não concorde com qualquer alteração notificada ele
          poderá pedir, imediatamente, o cancelamento de sua conta e apresentar
          a sua ressalva ao serviço de atendimento, se assim o desejar.
        </p>
      </li>
      <li>
        Dos Direitos aplicáveis e do foro
        <p>
